...
- **Misc:** Zod, Next.js, React Router, Redux, Zustand, TanStack Query, React Hook Form, Prisma, Drizzle, JWT, Socket.IO, NATS, pg-boss, RxJS, InversifyJS, Pydantic, PayPal, Stripe, RevenueCat, Strapi, Auth0, Retool, Postman, Figma & The Bitcoin Protocol
